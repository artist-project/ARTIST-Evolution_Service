...
using EvolutionService.Engine.Atl.Definitions;
using EvolutionService.Engine.Atl.Domain;

namespace EvolutionService.Engine.Atl.Rules
{
    ...
    public class RemoveRuleRule : NRules.Fluent.Dsl.Rule
    {
        public override void Define()
        {
            ...
            When()
                ...
                .Not<Rule>(n => n.Version == "New",
                    n => n.Name == oldNode.Name,
                    n => n.Parent.Name == oldNode.Parent.Name);

            Then()
                .Do(ctx => ctx.Insert(new RemoveRule()
            {
                Name = oldNode.Name,
                Parent = oldNode.Parent
            }));
